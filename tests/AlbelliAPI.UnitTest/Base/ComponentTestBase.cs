...
using Albelli.UnitTests.AutoFixture;
using AutoFixture;
...
namespace Albelli.UnitTests.Base;
...
public class ComponentFixtureBase
{
    ...
    public readonly AlbelliContext Context;
    ...
    private static (IValidatorFactory, IMongoClient, AlbelliContext, MongoDbRunner) GetFluentValidationValidatorFactory()
    {
        ...
        serviceCollection
            ...
            .AddFluentValidation(m =>
                m.RegisterValidatorsFromAssemblyContaining<GetPopularMakelaarsQueryValidator>());
        ...
        AlbelliContext context = new AlbelliContext(client);
    ...
    {
        var db = client.GetDatabase("AccountDb");

        string[] tables = { "Users", "EmailDomainCorrections", "UserAttributes", "SecurityChecks", "UserReviews", "UserPhoneChangeLogs" };
